		...
		document.addEventListener('DOMContentLoaded', function(){ 
		    ...
		    for (var i=0; i<mtimes.length; i++)
		    {
		        ...
		        if (mtime)
		        {
		            ...
		            mtimes[i].textContent = d.toLocaleString("en-GB");
		        }
		    }
	      ...
	      <table id="contents">
	        <tbody>
	          ...
	          <xsl:for-each select="file">
	            <tr class="file">
	              <td class="icon"><a href="{.}"><i class="icon icon-file">&#xf15b;</i></a></td>
	              <td class="name"><a href="{.}"><xsl:value-of select="." /></a></td>
	              <td class="size"><a href="{.}"><xsl:value-of select="./@size" /></a></td>
	              <td class="mtime"><a href="{.}"><xsl:value-of select="./@mtime" /></a></td>
                  <td class="actions">
			<ul>
				<li><a href="{.}" data-action="download" download="{.}" class="icon icon-download">&#x21e7;</a></li>
			</ul>
				  </td>
				  <td class="actions">
			<ul>
